...
const badgeVariants = cva(
  "inline-flex items-center gap-1.5 rounded-sm border px-2 py-0.5 text-[length:var(--ct-text-micro)] font-mono uppercase tracking-[var(--ct-tracking-wide)] leading-[var(--ct-leading-none)] transition-colors",
  {
    variants: {
      variant: {
        default:
