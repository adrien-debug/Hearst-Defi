...
const badgeVariants = cva(
  "inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-[0.625rem] font-medium uppercase tracking-widest leading-none backdrop-blur-md shadow-sm transition-colors",
  {
    variants: {
      variant: {
        default:
